...
public abstract class Cell : MonoBehaviour, IGraphNode, IEquatable<Cell>
{
    ...
    /// <summary>
    ///  Method marks the cell to give user an indication of a unit's attack range.
    /// </summary>
    ...
    /// <summary>
    /// Method marks the cell go give user an indication of a unit's allies.
    /// </summary>
    ...
    /// <summary>
    ///  Method marks the cell as a highlighted attack. Called when the mouse is over the cell.
    /// </summary>
    public abstract void MarkAsHighlightAttackable();
    /// <summary>
    ...
    public override int GetHashCode()
    {
        ...
        hash = (hash * 37) + (int)Coord.x;
        hash = (hash * 37) + (int)Coord.y;
        return hash;
